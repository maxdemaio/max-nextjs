export default function YoutubeStats({ stats }) {
  return (
    <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 w-full">
      <div className="transition duration-500 ease-in-out hover:-translate-y-2 shadow-md outline outline-1 outline-gray-200 dark:outline-gray-800 rounded p-4 max-w-72 w-full">
        <h3 className="text-gray-900 dark:text-gray-100">Total Subscribers</h3>
        <p className="text-3xl font-bold spacing-sm text-black dark:text-white">
