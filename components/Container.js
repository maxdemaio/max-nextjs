  ...
  return (
    <div>
      ...
      <nav className="flex items-center justify-between w-full max-w-4xl p-8 mx-auto my-0 text-gray-900 bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-60 dark:text-gray-100">
        ...
        <Link href="/posts">
          <a className="nav-no-show text-blue-400 hover:text-blue-600">Posts</a>
        </Link>
        <Link href="/posts">
          <a
            aria-label="Posts Link"
            className="md:hidden w-10 h-10 p-3 bg-gray-200 rounded dark:bg-gray-800"
          >
        ...
        <Link href="/software">
          <a className="nav-no-show text-blue-400 hover:text-blue-600">
            Software
          </a>
        </Link>
        <Link href="/software">
