...
export default function Container(props) {
  ...
  return (
    <div>
      ...
      <nav className="p-8 mb-6 flex items-center justify-between w-full max-w-4xl mx-auto text-gray-900 bg-white dark:bg-black dark:text-gray-100">
        <Link href="/">
          <a
            id="home-nav"
          ...
          <Link href="/software">
            ...
            >
              <svg width="1em" height="1em" viewBox="0 0 24 24">
                <path
                  d="M24 8H16V0H24V8ZM18 6H22V2H18V6Z"
                  fill="currentColor"
                />
                <path
