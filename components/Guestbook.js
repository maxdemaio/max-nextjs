          ...
          <div>
            <div className="mb-4 flex flex-row justify-between items-center">
              <a
                ...
                className="mb-4 bg-blue-600 hover:bg-blue-800 text-md text-white font-bold py-2 px-4 rounded"
                onClick={(e) => {
                  e.preventDefault();
                  signIn('github', {
          ...
          <div>
            <div className="mb-4 flex flex-row flex-wrap justify-between items-center">
              ...
              >
                ...
                <button
                  type="submit"
                  className="ml-2 bg-blue-600 hover:bg-blue-800 text-md text-white font-bold py-2 px-4 rounded"
                >
